...
class RBeli_gdgController extends Controller
{
   ...
   public function report()
    {
        ...
        return view('oreport_beli_gdg.report')->with(['cbg' => $cbg])->with(['hasil' => []]);
    }
	
	 
	public function jasperBeli_gdgReport(Request $request) 
	{
		$file 	= 'belin_gdg';
		...
		if($request->has('filter'))
		{
			...
			return view('oreport_beli_gdg.report')->with(['cbg' => $cbg])->with(['hasil' => $query]);
		}
