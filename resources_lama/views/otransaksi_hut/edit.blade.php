                        ...
                        <div class="tab-content mt-3">
							...
							<div class="form-group row">
								...
								<div class="col-md-1" align="right">
                                  ...
                                  <input type="text" class="form-control KODES" onclick="browseSuplier()" id="KODES" name="KODES" placeholder="Pilih Supplier"value="{{$header->KODES}}" style="text-align: left" readonly >
