                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form id="columnToggleForm">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input column-checkbox" type="checkbox"
                                            value="3" id="columnHari" checked>
                                        <label class="form-check-label" for="columnHari">Hari</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input column-checkbox" type="checkbox"
                                            value="4" id="columnPersen">
                                        <label class="form-check-label" for="columnPersen">Persen (%)</label>
                                    </div>
                                </form>
                            </div>
