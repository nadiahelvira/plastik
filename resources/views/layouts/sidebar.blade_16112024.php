    ...
    <div class="vertical-menu">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link"   data-bs-toggle="tooltip" title="Nadia" >
...
<!-----------------batas ------------------------>
          ...
          @if ( (Auth::user()->divisi=="programmer") || (Auth::user()->divisi=="owner") || (Auth::user()->divisi=="purchase"))
			      <a href="#" class="nav-link"  data-bs-toggle="tooltip" title="Januar" >
...
<!------- penambahan tampilan baru ------->
          ...
          <div class="mega-menu" id="d">
            <div class="row d-flex">
              <div class="col-md-3">
                  <div class="menu-card" style="">
                    <a href="javascript:addTab('Barang', '{{url('rbrg')}}')">
                      <!-- <i class="nav-icon fas fa-cart-plus icon-yellow"></i>  -->
              ...
              <div class="col-md-3">
                  <div class="menu-card" style="">
                    <a href="javascript:addTab('Suplier', '{{url('rsup')}}')">
                        <!-- <i class="nav-icon fas fa-store icon-white"></i> -->
                          <i style="margin-left:-5px;font-size: 40px;" class="nav-icon fas fa-user-tie icon-green"></i>
                        <h6>Suplier</h6>
                      </a>
              ...
              <div class="col-md-3">
                  <div class="menu-card" style="">
                    <a href="javascript:addTab('Customer', '{{url('rcust')}}')">
                        <!-- <i class="nav-icon fas fa-store icon-white"></i> -->
...
<!------- penambahan tampilan baru ------->
          ...
          <div class="mega-menu" id="e">
            <div class="row d-flex">
              <div class="col-md-3">
                  <div class="menu-card" style="">
                    <a href="javascript:addTab('Purchase Order', '{{url('rpo')}}')">
                      <!-- <i class="nav-icon fas fa-cart-plus icon-yellow"></i>  -->
              ...
              <div class="col-md-3">
                  <div class="menu-card" style="">
                      <a href="javascript:addTab('Pembelian', '{{url('rbeli')}}')">
                        <!-- <i class="nav-icon fas fa-store icon-white"></i> -->
              ...
              <div class="col-md-3">
                <div class="menu-card" style="">
                    <a href="javascript:addTab('Transaksi Hutang', '{{url('rthut')}}')" >
                      <!-- <i class="nav-icon fas fa-crop icon-orange"></i> -->
              ...
              <div class="col-md-3">
                <div class="menu-card" style="">
                    <a href="javascript:addTab('U.M Pembelian', '{{url('rum')}}')" >
                      <!-- <i class="nav-icon fas fa-crop icon-orange"></i> -->
                        <i style="margin-left:-5px;font-size: 40px;" class="nav-icon fas fa-wallet icon-red"></i>
                      <h6>U.M Pembelian</h6>
                    </a>
            ...
            <div class="row">
              <div class="col-md-3">
                  <div class="menu-card" style="">
                    <a href="javascript:addTab('Pembayaran Hutang', '{{url('rhut')}}')" >
                      <!-- <i class="nav-icon fas fa-anchor icon-blue" style="text-align: center;"></i> -->
              ...
              <div class="col-md-3">
                  <div class="menu-card" style="">
                    <a href="javascript:addTab('Pembelian Gudang', '{{url('rbeli_gdg')}}')" >
                        <!-- <i class="nav-icon fas fa-store icon-white"></i> -->
...
<!------- penambahan tampilan baru ------->
            ...
            <div class="mega-menu" id="f">
              <div class="row d-flex">
                <div class="col-md-3">
                    <div class="menu-card" style="">
                      <a href="javascript:addTab('Sales Order', '{{url('rso')}}')">
                        <!-- <i class="nav-icon fas fa-cart-plus icon-yellow"></i>  -->
                          <i style="margin-left:-5px;font-size: 40px;" class="nav-icon fas fa-user-tie icon-green"></i>
                        <h6>Sales Order</h6>
                      </a>
                ...
                <div class="col-md-3">
                    <div class="menu-card" style="">
                      <a href="javascript:addTab('Surat Jalan', '{{url('rsurats')}}')">
                          <!-- <i class="nav-icon fas fa-store icon-white"></i> -->
                ...
                <div class="col-md-3">
                    <div class="menu-card" style="">
                      <a href="javascript:addTab('Penjualan', '{{url('rjual')}}')">
                          <!-- <i class="nav-icon fas fa-store icon-white"></i> -->
                            <i style="margin-left:-5px;font-size: 40px;" class="nav-icon fas fa-store icon-purple"></i>
                          <h6>Penjualan</h6>
                        </a>
                ...
                <div class="col-md-3">
                    <div class="menu-card" style="">
                      <a href="javascript:addTab('Transaksi Piutang', '{{url('rtpiu')}}')">
                        <!-- <i class="nav-icon fas fa-anchor icon-blue" style="text-align: center;"></i> -->
              ...
              <div class="row">
                <div class="col-md-3">
                    <div class="menu-card" style="">
                      <a href="javascript:addTab('U.M Penjualan', '{{url('ruj')}}')" >
                        <!-- <i class="nav-icon fas fa-anchor icon-blue" style="text-align: center;"></i> -->
                ...
                <div class="col-md-3">
                  <div class="menu-card" style="">
                      <a href="javascript:addTab('Pembayaran Piutang', '{{url('rpiu')}}')">
                        <!-- <i class="nav-icon fas fa-crop icon-orange"></i> -->
                ...
                <div class="col-md-3">
                  <div class="menu-card" style="">
                      <a href="javascript:addTab('Koreksi Stock', '{{url('rstockb')}}')" >
                        <!-- <i class="nav-icon fas fa-crop icon-orange"></i> -->
