        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{($tipx=='new')? url('/lokasi/store/') : url('/lokasi/update/'.$header->NO_ID ) }}" method="POST" name ="entri" id="entri" >
...
<script>
	...
	// 	{
	// 		window.location ="{{url('/lokasi/delete/'.$header->NO_ID )}}'";
	// 		//return true;
	// 	} 
	// 	return false;
	// }
		...
		Swal.fire({
			...
			if (result.isConfirmed) {
				...
				Swal.fire({
	            	...
	            	loc = "{{ url('/lokasi/delete/'.$header->NO_ID) }}"  ;
	...
	function CariBukti() {
		...
		var cari = $("#CARI").val();
		var loc = "{{ url('/lokasi/edit/') }}" + '?idx={{ $header->NO_ID}}&tipx=search&kodex=' +encodeURIComponent(cari);
		window.location = loc;
