                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form id="columnToggleForm">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input column-checkbox" type="checkbox"
                                            value="2" id="columnType" checked>
                                        <label class="form-check-label" for="columnType">Type</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input column-checkbox" type="checkbox"
                                            value="3" id="columnKomisi" checked>
                                        <label class="form-check-label" for="columnKomisi">Komisi</label>
                                    </div>
                                </form>
                            </div>
...
<script>
  ...
  $(document).ready(function() {
        ...
        $("div.test_btn").html('<a class="btn btn-lg btn-md btn-success" href="{{url('komisi/edit?idx=0&tipx=new')}}"> <i class="fas fa-plus fa-sm md-3" ></i></a');
    });
