...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">Edit Surat {{$header->NO_BUKTI}}</h1>	
				</div>
				<div class="col-sm-6">
                        ...
                        <div class="tab-content mt-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4 input-group">
                                    <input type="text" class="form-control NO_SO" id="NO_SO" name="NO_SO" placeholder="Masukkan SO#" value="{{$header->NO_SO}}" readonly>
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text"  class="form-control SISA" id="SISA" name="SISA" placeholder="-" value="{{ number_format( $header->SISA, 2, '.', ',') }}" style="text-align: right; width:140px" readonly>
                                </div>
                           </div>
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control KODET" id="KODET" name="KODET" placeholder="Masukkan Tujuan#" value="{{$header->KODET}}" readonly style="width:140px">
                                </div>
                                <div class="col-md-2" align="right">
                                    <label for="NAMAT" class="form-label">-</label>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control NAMAT" id="NAMAT" name="NAMAT" placeholder="-" value="{{$header->NAMAT}}" readonly>
                                </div>
                            </div>
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" onclick="select()" onkeyup="hitung()" class="form-control KG" id="KG" name="KG" placeholder="Masukkan Kg" value="{{ number_format( $header->KG, 2, '.', ',') }}" style="text-align: right; width:140px" {{ ($header->MASUK!=0 && $header->KELUAR!=0) ? 'readonly' : '' }}>
                                </div>
                                <div class="col-md-2" align="right">
                                    <label for="HARGA" class="form-label">Harga</label>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" onclick="select()" onkeyup="hitung()" class="form-control HARGA" id="HARGA" name="HARGA" placeholder="HARGA" value="{{ number_format( $header->HARGA, 2, '.', ',') }}" style="text-align: right; width:140px">
                                </div>
                            </div>
