...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">Tambah Surat Jalan Baru</h1>
				</div>
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="/surat">Transaksi Surat Jalan </a></li>
                    ...
                    <form action="store" id="entri"  method="POST">
                        ...
                        <div class="tab-content mt-3">
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control NO_BUKTI" id="NO_BUKTI" name="NO_BUKTI" placeholder="Masukkan Bukti#" value="+" readonly style="width:140px">
                                </div>
                                ...
                                <div class="col-md-4">
                                   <input class="form-control date" id="TGL" name="TGL" data-date-format="dd-mm-yyyy" type="text" autocomplete="off" value="{{ now()->format('d-m-Y') }}" style="width:140px">				
                                </div>
                            </div>
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control KODEC" id="KODEC" name="KODEC" placeholder="Masukkan Customer#" readonly style="width:140px">
                                </div>
                                <div class="col-md-2" align="right">
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control KD_BRG" id="KD_BRG" name="KD_BRG" placeholder="Masukkan Barang" readonly style="width:140px">
                                </div>
                                <div class="col-md-2" align="right">
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text"  class="form-control SISA" id="SISA" name="SISA" placeholder="-" value="{{ number_format(0, 2, '.', ',') }}" style="text-align: right; width:140px" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control TRUCK" id="TRUCK" name="TRUCK" placeholder="Masukkan Truck" style="width:140px">
                                </div>
                                <div class="col-md-2" align="right">
                                    <label for="SOPIR" class="form-label">Sopir</label>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control SOPIR" id="SOPIR" name="SOPIR" placeholder="Masukkan Sopir">
                                </div>
                            </div>
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control KODET" id="KODET" name="KODET" placeholder="Masukkan Tujuan#" readonly style="width:140px">
                                </div>
                                <div class="col-md-2" align="right">
                                    <label for="NAMAT" class="form-label">-</label>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control NAMAT" id="NAMAT" name="NAMAT" placeholder="-" readonly>
                                </div>
                            </div>
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" onclick="select()" onkeyup="hitung()" class="form-control KG" id="KG" name="KG" placeholder="Masukkan Kg" value="{{ number_format(0, 2, '.', ',') }}" style="text-align: right; width:140px" >
                                </div>
                                <div class="col-md-2" align="right">
                                    <label for="HARGA" class="form-label">Harga</label>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" onclick="select()" onkeyup="hitung()" class="form-control HARGA" id="HARGA" name="HARGA" placeholder="HARGA" value="{{ number_format(0, 2, '.', ',') }}" style="text-align: right; width:140px">
                                </div>
                            </div>
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control TOTAL" id="TOTAL" name="TOTAL" placeholder="TOTAL" value="{{ number_format(0, 2, '.', ',') }}" style="text-align: right; width:140px" readonly>
                                </div>
                            </div>
