                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form id="columnToggleForm">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input column-checkbox" type="checkbox"
                                            value="3" id="columnNopol" checked>
                                        <label class="form-check-label" for="columnNopol">Nopol</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input column-checkbox" type="checkbox"
                                            value="4" id="columnMaxkub">
                                        <label class="form-check-label" for="columnMaxKub">Max Kubikasi</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input column-checkbox" type="checkbox"
                                            value="5" id="columnMaxber">
                                        <label class="form-check-label" for="columnMaxber">Max Berat</label>
                                    </div>
                                </form>
                            </div>
                ...
                <table class="table table-fixed table-striped table-border table-hover nowrap datatable" id="datatable">
                    <thead class="table-dark">
                        <tr>										
                            ...
                            <th scope="col" style="text-align: center">Nopol</th>
                            <th scope="col" style="text-align: center">Max Kubikasi</th>
                            <th scope="col" style="text-align: center">Max Berat</th>
                        </tr>
                    </thead>
...
<script>
  ...
  $(document).ready(function() {
        ...
        $("div.test_btn").html('<a class="btn btn-lg btn-md btn-success" href="{{url('truck/edit?idx=0&tipx=new')}}"> <i class="fas fa-plus fa-sm md-3" ></i></a');
    });
