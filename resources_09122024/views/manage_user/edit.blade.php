              ...
              <div class="card-body">
                ...
                <form method="POST" action="{{url('/user/update/'.$id)}}">
                    ...
                    <div class="form-group">
                        ...
                        <select name="CBG" id="CBG" class="btn-group btn-block" style="padding: 10px" required>
                            <option value="A" <?php if($CBG=='A') echo 'selected="selected"' ?>>A</option>
                            <option value="B" <?php if($CBG=='B') echo 'selected="selected"' ?>>B</option>
                        </select>
                    </div>

                    <!-- Cabang -->
                    <div class="form-group">
                        <x-label for="PPN" :value="__('PPN/Non')" />
                        <select name="PPN" id="PPN" class="btn-group btn-block" style="padding: 10px" required>
                            <option value="0" <?php if($PPN=='0') echo 'selected="selected"' ?>>Non PPN</option>
                            <option value="1" <?php if($PPN=='1') echo 'selected="selected"' ?>>PPN</option>
                        </select>
                    </div>
