                        ...
                        <div class="tab-content mt-3">
							...
							<div class="form-group row">
								...
								<div class="col-md-4">
									...
									<input hidden type="text" onclick="select()" onblur="jtempos()" class="form-control HARI" id="HARI" name="HARI" placeholder="Masukkan HARI" 
								...
								<div class="col-md-1">
										...
										<input type="text" class="form-control PKP" id="PKP" name="PKP" value="{{$header->PKP}}"placeholder="" readonly >
